...
Банк импортируется командой `make questions`. CSV является источником истины:
при импорте отсутствующие в файле старые вопросы остаются в PostgreSQL для
истории, но помечаются неактивными и больше не выдаются новым сессиям.
