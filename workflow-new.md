...
- `media/pic1.PNG` показывается в начале, `media/vid1-kdir.mp4` — после текста урока, `media/pic2.PNG` — после видео перед кнопкой старта.
...
После текста бот отправляет видео `media/vid1-kdir.mp4`, затем `media/pic2.PNG` и кнопку `Готов(а), начинаем`. Утверждённый текст урока служит пояснением к ролику; отдельной подписи у видео пока нет. До нажатия кнопки вопросный блок не начинается.
