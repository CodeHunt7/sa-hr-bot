...
Этот файл описывает согласованную целевую логику следующей версии бота. Код пока реализует предыдущую минимальную версию. Исходный файл `Workflow-by-DanyaClaude.md` остаётся неизменным.
